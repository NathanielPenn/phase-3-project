...
bream = Fish(name='Bream', season='Spring', price=45, location_id=1, bait_id=2)  

# create fish instances  - Pelican Town - Summer
catfish = Fish(name='Catfish', season='Summer', price=200, location_id=1, bait_id=1)  
sunfish = Fish(name='Pike', season='Summer', price=30, location_id=1, bait_id=2)  

# create fish instances  - Pelican Town - Fall  
tiger_trout = Fish(name='Tiger Trout', season='Fall', price=150, location_id=1, bait_id=2)
...
red_snapper = Fish(name='Red Snapper', season='Summer', price=50, location_id=3, bait_id=4)  
pufferfish = Fish(name='Pufferfish', season='Summer', price=200, location_id=3, bait_id=1)

# # create fish instances  - Beach - Fall
sardine = Fish(name='Sardine', season='Fall', price=40, location_id=3, bait_id=1)  
albacore = Fish(name='Albacore', season='Fall', price=75, location_id=3, bait_id=1)
super_cucumber = Fish(name='Super Cucumber', season='Fall', price=250, location_id=3, bait_id=1)

# # create fish instances  - Beach - Winter
red_mullet = Fish(name='Red Mullet', season='Winter', price=75, location_id=3, bait_id=3)  
squid = Fish(name='Squid', season='Winter', price=80, location_id=3, bait_id=1)
pike = Fish(name='Pike', season='Winter', price=100, location_id=3, bait_id=1)



# #create fish instances Cindsnap Forest - Spring
chub = Fish(name='Chub', season='Spring', price=50, location_id=2, bait_id=2)

# #create fish instances Cindsnap Forest - Summer
dorado = Fish(name='Dorado', season='Summer', price=100, location_id=2, bait_id=1)

# #create fish instances Cindsnap Forest - Fall
salmon = Fish(name='Salmon', season='Fall', price=75, location_id=2, bait_id=2)

# #create fish instances Cindsnap Forest - Winter
midnight_carp = Fish(name='Midnight Carp', season='Winter', price=225, location_id=2, bait_id=4) 

# #create fish instances Mountain - Spring
bullhead = Fish(name='Bullhead', season='Spring', price=75, location_id=4, bait_id=1)
large_mouth_bass = Fish(name='Large Mouth Bass', season='Spring', price=100, location_id=4, bait_id=3)

# #create fish instances Mountain - Summer
sturgeon = Fish(name='Sturgeon', season='Summer', price=200, location_id=4, bait_id=2)

# #create fish instances Mountain - Fall
walleye = Fish(name='Walleye', season='Fall', price=105, location_id=4, bait_id=1)

# #create fish instances Mountain - Winter
perch = Fish(name='Perch', season='Winter', price=55, location_id=4, bait_id=4) 



# #create fish instances Mine - Null

ghostfish = Fish(name='Ghostfish', season='year round', price=45, location_id=7, bait_id=3) 
stonefish = Fish(name='Stonefish', season='year round', price=300, location_id=7, bait_id=4) 
ice_pip = Fish(name='Ice Pip', season='year round', price=500, location_id=7, bait_id=1) 
lava_eel = Fish(name='Lava Eel', season='year round', price=700, location_id=7, bait_id=1) 


# #create fish instances Secret Woods - Null
woodskip = Fish(name='Woodskip', season='year round', price=75, location_id=8, bait_id=2) 

# #create fish instances The Desert - Null
sandfish = Fish(name='Sandfish', season='year round', price=75, location_id=5, bait_id=1)
scorpion_carp = Fish(name='Scorpion Carp', season='year round', price=150, location_id=5, bait_id=4)
...
#create fish instances Witch Swamp - year round
void_salmon = Fish(name='Void Salmon', season='year round', price=150, location_id=11, bait_id=1) 


# #create fish instances Ginger Island - year round
blue_discus = Fish(name='Blue Discus', season='year round', price=120, location_id=12, bait_id=2)
lionfish = Fish(name='Lionfish', season='year round', price=100, location_id=12, bait_id=3)
tilapia = Fish(name='Tilapia', season='year round', price=75, location_id=12, bait_id=4)


# #create fish instances Pirate Cove - Null
stingray = Fish(name='Stingray', season='year round', price=180, location_id=13, bait_id=3)
...
cindersap_forest = Location(name='Cindersap Forest', type='River', water='Fresh')
